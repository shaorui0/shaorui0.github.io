...
[https://www.zhihu.com/question/28586791/answer/767316172](https://www.zhihu.c
om/question/28586791/answer/767316172)

[ __ What happens when you type a URL in the browser and press enter
](/2021/03/08/What-happens-when-you-type-a-URL-in-the-browser-and-press-
enter/)

[ random - seed - magic number 42 __ ](/2021/03/09/random-seed-magic-
number-42/)
  ...
  * 站点概览 
  ...
  1. 1. 什么是 Restful ？
    1. 1.1. 一定好吗？所有的场景都能用吗？
  2. 2. diff Get and Post
    1. 2.1. 浏览器的GET和POST
    2. 2.2. 用 HTTP 作为接口传输协议
    3. 2.3. 关于安全性
    4. 2.4. 关于编码
      1. 2.4.1. 对 header 和 body 的分开处理
    5. 2.5. 总结
  3. 3. diff Post and Put
